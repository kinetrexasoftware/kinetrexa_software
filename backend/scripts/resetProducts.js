...
const productsData = [
    {
        ...
        websiteLink: "https://admin.homesarthi.com",
        androidLink: "https://play.google.com/store/apps/details?id=com.homesarthi",
        iosLink: "",
...
const resetProducts = async () => {
    ...
    try {
        ...
        await Product.deleteMany({}); // WIPE ALL PRODUCTS

        console.log('Inserting 3 specific products...');
        await Product.insertMany(productsData);

        console.log('Products reset successfully. Removed extras.');
        process.exit();
    } catch (error) {
